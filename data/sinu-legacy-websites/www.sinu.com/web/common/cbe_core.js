...
*/
var cbeVersion="4.20", cbeDocumentId='idDocument', cbeWindowId='idWindow', cbeAll=new Array();
...
function _domSetWidth(ele,uW){
  ...
  else if (_def(ele.offsetWidth, ele.style.pixelWidth)) { // O7 work-around until getComputedStyle is implemented
    ele.style.width = uW + "px";
    pl = ele.offsetWidth - ele.style.pixelWidth;
  }
...
function _domSetHeight(ele,uH){
  ...
  else if (_def(ele.offsetHeight, ele.style.pixelHeight)) { // O7 work-around until getComputedStyle is implemented
    ele.style.height = uH + "px";
    pt = ele.offsetHeight - ele.style.pixelHeight;
  }
...
function ClientSnifferJr(){
  ...
  this.pc =  (this.ua.indexOf('windows')!=-1 || this.ua.indexOf('win')!=-1);
